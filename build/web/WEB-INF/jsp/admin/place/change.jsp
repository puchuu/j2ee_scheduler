...
<html>
    ...
    <body>
		...
		<form action="/admin/place/change_action" method="post">
			...
			<div class="positionNamespace">
				<span>Position</span>
				<input readonly="readonly" type="text" name="latitude" class="latitude" size="16" value="<c:out value="${latitude}" />" />
				<input readonly="readonly" type="text" name="longitude" class="longitude" size="16" value="<c:out value="${longitude}" />" />
