...
<html>
    ...
    <body>
		...
		<form action="/admin/transport/create_action" method="post">
			...
			<div>
				<span>Start</span>
				<input class="start" type="text" name="start" value="<c:out value="${param.start}" />" />
			</div>
			<div>
				<span>End</span>
				<input class="end" type="text" name="end" value="<c:out value="${param.end}" />" />
			</div>
			<div>
				<span>Spend</span>
				<input class="spend" type="text" name="spend" value="<c:out value="${param.spend}" />" />
			</div>
			<div>
				<span>Period</span>
				<input class="period" type="text" name="period" value="<c:out value="${param.period}" />" />
			</div>
			<div>
				<span>Image</span>
			...
			<div>
				<span>Number</span>
				<input class="number" type="text" name="number" value="<c:out value="${param.period}" />" />
			</div>
