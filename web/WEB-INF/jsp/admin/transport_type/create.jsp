...
<html>
    <head>
        ...
        <title>Create new transport type</title>
    ...
    <body>
		...
		<form action="/admin/transport_type/create_action" method="post">
			<div>
				<span>Name</span>
			...
			<div>
				<span>Speed</span>
				<input type="text" class="speed" name="speed" value="<c:out value="${param.speed}" />" />
			</div>
